		...
		function myfooter() {
			...
			document.getElementById("bar2").style.backgroundImage = "linear-gradient(black, blue)";
		...
		function mytopbar() {
			...
			function myfooter1() {
				...
				document.getElementById("bar2").style.backgroundImage = "linear-gradient(black, green)";
			...
			function myfooter2() {
				...
				document.getElementById("bar2").style.backgroundImage = "linear-gradient(black, grey)";	
			}
			function mytopbar2() {
			...
			function myfooter3() {
				...
				document.getElementById("bar2").style.backgroundImage = "linear-gradient(white, grey)";
			...
			function myfooter4() {
				...
				document.getElementById("bar2").style.backgroundImage = "linear-gradient(black, purple)";
  	...
  	function showDivs(n) {
  		...
  		if (n > x.length) {slideIndex = 1}
  			...
  			document.getElementById("myBtnBg").onclick = function gppfunction() {
  				...
  				document.getElementById("bar2").style.backgroundImage = colors[index];
